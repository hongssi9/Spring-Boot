...
<head>
    ...
    <c:if test="${not empty param.error}"> <!-- 값이 비어있거나 틀리면 에러메시지 표시 -->
    <script>
    	alert("회원 아이디 또는 비밀번호가 올바르지 않습니다.");
    </script>
    </c:if>
</head>
                ...
                <div class="margin-top first">
                    ...
                    <form class="login-form" method="post">
                        <fieldset>
                            ...
                            <div style="color:red;border: 1px solid red; font-weight:bold;">
                            	회원 아이디 또는 비밀번호가 올바르지 않습니다.
                            </div>
                            </c:if>
